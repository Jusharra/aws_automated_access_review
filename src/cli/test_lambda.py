...
def main():
    ...
    parser = argparse.ArgumentParser(description='Test AWS Access Review Lambda function locally')
    ...
    report_bucket = args.bucket if args.bucket else input("Enter S3 bucket name for reports (or leave empty to skip S3 upload): ")
    ...
    try:
        ...
        print("Error: Could not import the Lambda handler. Make sure the deployment directory contains index.py")
        sys.exit(1)
