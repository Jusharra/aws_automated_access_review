...
def generate_fallback_narrative():
    ...
    return (
        ...
        "## Next Steps\n\n"
        "For detailed findings and specific recommendations, please consult the attached CSV report. "
        "Consider scheduling a follow-up security review once the highest priority items have been addressed.\n\n"
        "---\n"
